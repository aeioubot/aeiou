...
module.exports = class ReplyCommand extends Command {
	...
	async run(msg, args) {
		...
		msg.guild.roles.find('id', donor.role).setName(name).catch(() => msg.say('It looks like I don\'t have permission to manage your role. Please make sure my role is above yours.'));
